...
//	single_cycle_v2_v1_0_S00_AXI # ( 
//		.C_S_AXI_DATA_WIDTH(C_S00_AXI_DATA_WIDTH),
//		.C_S_AXI_ADDR_WIDTH(C_S00_AXI_ADDR_WIDTH)
//	) single_cycle_v2_v1_0_S00_AXI_inst (
...
//	);
	...
	single_cycle_CSR_v1_0_S00_AXI # ( 
                    .C_S_AXI_DATA_WIDTH(C_S00_AXI_DATA_WIDTH),
                    .C_S_AXI_ADDR_WIDTH(C_S00_AXI_ADDR_WIDTH)
                ) single_cycle_CSR_v1_0_S00_AXI_inst (
                    .S_AXI_ACLK(s00_axi_aclk),
                    .S_AXI_ARESETN(s00_axi_aresetn),
                    .S_AXI_AWADDR(s00_axi_awaddr),
                    .S_AXI_AWPROT(s00_axi_awprot),
       ...
       riscv_processor single_cycle_processor(
                    .clk(bram_clk),
                    .reset_n(rstn_ctrl[0]),
                    .instr_mem_addr_FPGA(bram_im_addr),
                    .write_data_IM_FPGA(bram_wrdata_im),
                    .we_IM_FPGA(bram_we_im),
